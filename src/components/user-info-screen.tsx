  ...
  return (
    <div className="flex flex-col space-y-10">
      ...
      <div className="space-y-12">
        <div>
          <h3 className="text-2xl font-semibold mb-6">{t('userInfo.age')}:</h3>
          <div className="px-4">
            <div className="flex justify-center mb-8">
              <span className="text-6xl font-bold text-blue-700">{age}</span>
              <span className="text-2xl text-blue-700 mt-2 ml-2">{t('common.years')}</span>
            </div>
            ...
            <input
              ...
              className="w-full h-8 appearance-none cursor-pointer bg-gray-200 rounded-full rtl-range-slider"
              style={{
                background: i18n.language === 'ar' 
                  ? `linear-gradient(to left, #2563eb 0%, #2563eb ${age}%, #e5e7eb ${age}%, #e5e7eb 100%)`
                  : `linear-gradient(to right, #2563eb 0%, #2563eb ${age}%, #e5e7eb ${age}%, #e5e7eb 100%)`,
              }}
            />
        ...
        <div>
          <h3 className="text-2xl font-semibold mb-6">{t('userInfo.selectGender')}:</h3>
      ...
      <div className="flex justify-between pt-6">
        ...
        >
          {isLoading ? t('common.loading') : t('buttons.continue')}
        </Button>
      </div>
    </div>
  );
